...
document.make_pie(activities, col_activities, 'Summary of maintenance kinds ({} acts realized).')
...
document.make_pie(activities, col_computers, 'Summary of maintenance location ({} acts realized).')
